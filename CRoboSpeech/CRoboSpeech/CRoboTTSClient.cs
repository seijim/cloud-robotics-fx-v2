...
namespace CRoboSpeech
{
    ...
    {
        public static string AccessUri = ConfigurationManager.AppSettings["SpeechAuthenticationUri"];
        private string apiKey = ConfigurationManager.AppSettings["SpeechSubscriptionKey"];
        ...
        private void OnTokenExpiredCallback(object stateInfo)
        {
            ...
            {
                string errorMessage = string.Format("Failed renewing access token. Details: {0}", ex.Message);
                MessageBox.Show("** Exception occured ** " + errorMessage, "Error");
            ...
            finally
            {
                ...
                {
                    string errorMessage = string.Format("Failed to reschedule the timer to renew access token. Details: {0}", ex.Message);
                    MessageBox.Show("** Exception occured ** " + errorMessage, "Error");
                }
            }
        }
